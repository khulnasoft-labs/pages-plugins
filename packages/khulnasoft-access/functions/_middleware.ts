...
type khulnasoftAccessPagesPluginFunction<
  Env = unknown,
...
// Adapted slightly from https://github.com/khulnasoft/workers-access-external-auth-example
...
export const onRequest: khulnasoftAccessPagesPluginFunction = async ({
  request,
